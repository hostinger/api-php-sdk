...
class BillingSubscriptionsApi
{
     ...
     */
    public function disableAutoRenewalV1(string $subscriptionId)
    {
        $request = new Request(
            method: 'DELETE',
            uri: $this->buildResourcePath('/api/billing/v1/subscriptions/{subscriptionId}/auto-renewal/disable', [
     ...
     * @throws ExceptionInterface
     */
    public function enableAutoRenewalV1(string $subscriptionId)
    {
        $request = new Request(
            method: 'PATCH',
            uri: $this->buildResourcePath('/api/billing/v1/subscriptions/{subscriptionId}/auto-renewal/enable', [
                'subscriptionId' => $subscriptionId
            ]),
            headers: $this->getHeaders(),
        );
     ...
     * @throws ExceptionInterface
     */
    public function renewSubscriptionV1(string $subscriptionId, ?\Hostinger\Model\BillingV1SubscriptionRenewalRenewRequest $billingV1SubscriptionRenewalRenewRequest = null)
    {
        $request = new Request(
            method: 'POST',
            uri: $this->buildResourcePath('/api/billing/v1/subscriptions/{subscriptionId}/renew', [
                'subscriptionId' => $subscriptionId
            ]),
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($billingV1SubscriptionRenewalRenewRequest, JsonEncoder::FORMAT),
        );
