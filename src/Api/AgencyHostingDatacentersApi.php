...
class AgencyHostingDatacentersApi
{
    ...
    /**
     * @return \Hostinger\Model\AgencyHostingV1DatacentersDatacenterResource[]
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function listAvailableDatacentersForAnAgencyPlanOrderV1(int $orderId)
    {
        $request = new Request(
            method: 'GET',
            uri: $this->buildResourcePath('/api/agency-hosting/v1/orders/{order_id}/datacenters', [
                'orderId' => $orderId
            ]),
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\AgencyHostingV1DatacentersDatacenterResource[]', JsonEncoder::FORMAT);
    }
