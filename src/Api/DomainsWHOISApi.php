...
class DomainsWHOISApi
{
     ...
     */
    public function cancelPendingIRTPVerificationV1(string $domain)
    {
        $request = new Request(
            method: 'DELETE',
            uri: $this->buildResourcePath('/api/domains/v1/irtp/{domain}', [
                'domain' => $domain
            ]),
     ...
     * @throws ExceptionInterface
     */
    public function changeWHOISProfileForDomainV1(\Hostinger\Model\DomainsV1WHOISChangeUpdateRequest $domainsV1WHOISChangeUpdateRequest)
    {
        $request = new Request(
            method: 'PUT',
            uri: '/api/domains/v1/whois/change',
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($domainsV1WHOISChangeUpdateRequest, JsonEncoder::FORMAT),
        );
    ...
    /**
     * @return \Hostinger\Model\DomainsV1IRTPVerificationResource
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function getPendingIRTPVerificationV1(string $domain)
    {
        $request = new Request(
            method: 'GET',
            uri: $this->buildResourcePath('/api/domains/v1/irtp/{domain}', [
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\DomainsV1IRTPVerificationResource', JsonEncoder::FORMAT);
    }
     ...
     * @throws ExceptionInterface
     */
    public function setWHOISProfileAsDefaultV1(int $whoisId)
    {
        $request = new Request(
            method: 'PUT',
            uri: $this->buildResourcePath('/api/domains/v1/whois/default/{whoisId}', [
                'whoisId' => $whoisId
            ]),
            headers: $this->getHeaders(),
        );
     ...
     * @throws ExceptionInterface
     */
    public function unsetDefaultWHOISProfileV1(int $whoisId)
    {
        $request = new Request(
            method: 'DELETE',
            uri: $this->buildResourcePath('/api/domains/v1/whois/default/{whoisId}', [
