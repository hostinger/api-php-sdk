...
class DomainsAvailabilityApi
{
     ...
     * @throws ExceptionInterface
     */
    public function suggestDomainNamesFromADescriptionV1(\Hostinger\Model\DomainsV1AvailabilityAlternativesFromDescriptionRequest $domainsV1AvailabilityAlternativesFromDescriptionRequest)
    {
        $request = new Request(
            method: 'POST',
            uri: '/api/domains/v1/availability/alternatives-from-description',
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($domainsV1AvailabilityAlternativesFromDescriptionRequest, JsonEncoder::FORMAT),
        );
     ...
     * @throws ExceptionInterface
     */
    public function suggestDomainNamesFromADomainV1(\Hostinger\Model\DomainsV1AvailabilityAlternativesFromDomainRequest $domainsV1AvailabilityAlternativesFromDomainRequest)
    {
        $request = new Request(
            method: 'POST',
            uri: '/api/domains/v1/availability/alternatives-from-domain',
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($domainsV1AvailabilityAlternativesFromDomainRequest, JsonEncoder::FORMAT),
        );
