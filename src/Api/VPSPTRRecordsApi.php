...
class VPSPTRRecordsApi
{
    ...
    public function createPTRRecordV1(int $virtualMachineId, int $ipAddressId, \Hostinger\Model\VPSV1VirtualMachinePTRStoreRequest $vPSV1VirtualMachinePTRStoreRequest)
    {
        $request = new Request(
            method: 'POST',
            uri: $this->buildResourcePath('/api/vps/v1/virtual-machines/{virtualMachineId}/ptr/{ipAddressId}', [
                'virtualMachineId' => $virtualMachineId, 'ipAddressId' => $ipAddressId
            ]),
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($vPSV1VirtualMachinePTRStoreRequest, JsonEncoder::FORMAT),
        );
