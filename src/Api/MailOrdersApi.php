...
class MailOrdersApi
{
    ...
    /**
     * @return \Hostinger\Model\MailGetMailOrderListV1200Response
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function getMailOrderListV1(?string $domain = null, ?string $status = null, ?bool $isTrial = null, ?string $sort = '-created_at', ?int $page = null, ?int $perPage = 25)
    {
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\MailGetMailOrderListV1200Response', JsonEncoder::FORMAT);
    }
