...
class AgencyHostingFilesApi
{
     ...
     */
    public function importAgencyPlanWebsiteFromArchiveV1(string $websiteUid, \Hostinger\Model\AgencyHostingV1FilesImportArchiveRequest $agencyHostingV1FilesImportArchiveRequest)
    {
        $request = new Request(
            method: 'POST',
