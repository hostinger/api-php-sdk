...
class EcommerceMiscellaneousApi
{
    ...
    /**
     * @return \Hostinger\Model\EcommerceV1MiscellaneousCustomStorefrontInstructionsResource
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function getCustomStorefrontSetupInstructionsV1()
    {
        $request = new Request(
            method: 'GET',
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\EcommerceV1MiscellaneousCustomStorefrontInstructionsResource', JsonEncoder::FORMAT);
    }
