...
class BillingOrdersApi
{
     ...
     */
    public function createPurchaseOrderV1(\Hostinger\Model\BillingV1OrderPurchaseRequest $billingV1OrderPurchaseRequest)
    {
        $request = new Request(
            method: 'POST',
            uri: '/api/billing/v1/orders',
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($billingV1OrderPurchaseRequest, JsonEncoder::FORMAT),
        );
