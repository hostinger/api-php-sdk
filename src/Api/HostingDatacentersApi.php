...
class HostingDatacentersApi
{
    ...
    /**
     * @return \Hostinger\Model\HostingV1DatacenterDatacenterResource[]
     *
     * @throws ApiException
    ...
    public function listAvailableDatacentersV1(int $orderId)
    {
        ...
        $request = new Request(
            method: 'GET',
            uri: '/api/hosting/v1/datacenters' . '?' . $query,
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\HostingV1DatacenterDatacenterResource[]', JsonEncoder::FORMAT);
    }
