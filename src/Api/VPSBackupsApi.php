...
class VPSBackupsApi
{
     ...
     */
    public function deleteBackupV1(int $virtualMachineId, int $backupId, ): \Hostinger\Model\CommonSuccessEmptyResource|\Hostinger\Model\BillingGetCatalogItemListV1401Response|\Hostinger\Model\BillingGetCatalogItemListV1500Response
    {
     ...
     * Get backup list
     *
     * @return \Hostinger\Model\VPSGetBackupListV1200Response|\Hostinger\Model\BillingGetCatalogItemListV1401Response|\Hostinger\Model\BillingGetCatalogItemListV1500Response
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @throws GuzzleException
     */
    public function getBackupListV1(int $virtualMachineId, ?int $page = null, ): \Hostinger\Model\VPSGetBackupListV1200Response|\Hostinger\Model\BillingGetCatalogItemListV1401Response|\Hostinger\Model\BillingGetCatalogItemListV1500Response
    {
     ...
     * @throws GuzzleException
     */
    public function restoreBackupV1(int $virtualMachineId, int $backupId, ): \Hostinger\Model\VPSV1ActionActionResource|\Hostinger\Model\BillingGetCatalogItemListV1401Response|\Hostinger\Model\BillingGetCatalogItemListV1500Response
    {
