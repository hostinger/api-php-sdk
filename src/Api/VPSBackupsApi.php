...
class VPSBackupsApi
{
    ...
    /**
     * Operation getBackupsV1
     *
     * Get backups
     *
     * @return \Hostinger\Model\VPSV1BackupListResponse|\Hostinger\Model\InlineObject1|\Hostinger\Model\InlineObject
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @throws GuzzleException
     */
    public function getBackupsV1(int $virtualMachineId, ?int $page = null, ): \Hostinger\Model\VPSV1BackupListResponse|\Hostinger\Model\InlineObject1|\Hostinger\Model\InlineObject
    {
        $request = $this->getBackupsV1Request($virtualMachineId, $page, );
        ...
        switch ($statusCode) {
            case 200:
                $returnType = '\Hostinger\Model\VPSV1BackupListResponse';
                break;
            case 401:
    ...
    /**
     * Create request for operation 'getBackupsV1'
     *
     * @throws InvalidArgumentException
     */
    protected function getBackupsV1Request(int $virtualMachineId,?int $page = null,): Request
    {
     ...
     * @throws GuzzleException
     */
    public function restoreBackupV1(int $virtualMachineId, int $backupId, ): \Hostinger\Model\VPSV1ActionActionResource|\Hostinger\Model\InlineObject1|\Hostinger\Model\InlineObject
    {
