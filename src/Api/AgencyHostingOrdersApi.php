...
class AgencyHostingOrdersApi
{
    ...
    /**
     * @return \Hostinger\Model\AgencyHostingListAgencyPlanOrdersV1200Response
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function listAgencyPlanOrdersV1(?int $page = null, ?int $perPage = 25)
    {
        ...
        $request = new Request(
            method: 'GET',
            uri: '/api/agency-hosting/v1/orders' . '?' . $query,
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\AgencyHostingListAgencyPlanOrdersV1200Response', JsonEncoder::FORMAT);
    }
