...
class HostingOrdersApi
{
    ...
    /**
     * @return \Hostinger\Model\HostingListOrdersV1200Response
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function listOrdersV1(?int $page = null, ?int $perPage = 25, ?array $statuses = null, ?array $orderIds = null)
    {
        ...
        $request = new Request(
            method: 'GET',
            uri: '/api/hosting/v1/orders' . '?' . $query,
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\HostingListOrdersV1200Response', JsonEncoder::FORMAT);
    }
