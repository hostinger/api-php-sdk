...
class DomainsForwardingApi
{
     ...
     * @throws ExceptionInterface
     */
    public function updateDomainForwardingV1(string $domain, \Hostinger\Model\DomainsV1ForwardingUpdateRequest $domainsV1ForwardingUpdateRequest)
    {
        $request = new Request(
            method: 'PUT',
            uri: $this->buildResourcePath('/api/domains/v1/forwarding/{domain}', [
            ...
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($domainsV1ForwardingUpdateRequest, JsonEncoder::FORMAT),
        );
