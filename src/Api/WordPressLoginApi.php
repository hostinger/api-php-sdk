...
class WordPressLoginApi
{
    ...
    /**
     * @return \Hostinger\Model\WordPressV1LoginLoginLinksResource
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function createLoginLinksV1(string $username, string $software)
    {
        $request = new Request(
            method: 'POST',
            uri: $this->buildResourcePath('/api/hosting/v1/accounts/{username}/wordpress/{software}/login/links', [
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\WordPressV1LoginLoginLinksResource', JsonEncoder::FORMAT);
    }
