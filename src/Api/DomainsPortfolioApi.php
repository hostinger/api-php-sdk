...
class DomainsPortfolioApi
{
    ...
    /**
     * @return \Hostinger\Model\DomainsV1PortfolioClaimResource
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function claimFreeDomainV1(\Hostinger\Model\DomainsV1PortfolioClaimRequest $domainsV1PortfolioClaimRequest)
    {
        $request = new Request(
            method: 'POST',
            uri: '/api/domains/v1/portfolio/claim',
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($domainsV1PortfolioClaimRequest, JsonEncoder::FORMAT),
        );
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\DomainsV1PortfolioClaimResource', JsonEncoder::FORMAT);
    }
     ...
     * @throws ExceptionInterface
     */
    public function completeDomainSetupV1(string $domain, \Hostinger\Model\DomainsV1PortfolioSetupRequest $domainsV1PortfolioSetupRequest)
    {
        $request = new Request(
            method: 'POST',
            uri: $this->buildResourcePath('/api/domains/v1/portfolio/{domain}/setup', [
                'domain' => $domain
            ]),
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($domainsV1PortfolioSetupRequest, JsonEncoder::FORMAT),
        );
    ...
    /**
     * @return \Hostinger\Model\DomainsV1PortfolioAuthCodeAuthCodeResource
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function getDomainAuthorizationCodeV1(string $domain)
    {
        $request = new Request(
            method: 'GET',
            uri: $this->buildResourcePath('/api/domains/v1/portfolio/{domain}/auth-code', [
                'domain' => $domain
            ]),
            headers: $this->getHeaders(),
        );
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\DomainsV1PortfolioAuthCodeAuthCodeResource', JsonEncoder::FORMAT);
    }
    ...
    /**
     * @return \Hostinger\Model\DomainsV1PortfolioRenewalRenewalInformationResource
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function getDomainRenewalInformationV1(string $domain)
    {
        $request = new Request(
            method: 'GET',
            uri: $this->buildResourcePath('/api/domains/v1/portfolio/{domain}/renewal', [
                'domain' => $domain
            ]),
            headers: $this->getHeaders(),
        );
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\DomainsV1PortfolioRenewalRenewalInformationResource', JsonEncoder::FORMAT);
    }
