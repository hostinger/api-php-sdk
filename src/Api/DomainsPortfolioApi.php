...
class DomainsPortfolioApi
{
     ...
     * Get domain list
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDomainListV1'] to see the possible values for this operation
     *
    ...
    public function getDomainListV1(
        string $contentType = self::contentTypes['getDomainListV1'][0]
    ): array|\Hostinger\Model\CommonSchemaUnauthorizedResponseSchema|\Hostinger\Model\CommonSchemaErrorResponseSchema
    {
        list($response) = $this->getDomainListV1WithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getDomainListV1WithHttpInfo
     *
     * Get domain list
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDomainListV1'] to see the possible values for this operation
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Hostinger\Model\DomainsV1DomainDomainResource[]|\Hostinger\Model\CommonSchemaUnauthorizedResponseSchema|\Hostinger\Model\CommonSchemaErrorResponseSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDomainListV1WithHttpInfo(
        string $contentType = self::contentTypes['getDomainListV1'][0]
    ): array
    {
        $request = $this->getDomainListV1Request($contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Hostinger\Model\DomainsV1DomainDomainResource[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Hostinger\Model\DomainsV1DomainDomainResource[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Hostinger\Model\DomainsV1DomainDomainResource[]', []),
    ...
    /**
     * Operation getDomainListV1Async
     *
     * Get domain list
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDomainListV1'] to see the possible values for this operation
     ...
     */
    public function getDomainListV1Async(
        string $contentType = self::contentTypes['getDomainListV1'][0]
    ): PromiseInterface
    {
        return $this->getDomainListV1AsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDomainListV1AsyncWithHttpInfo
     *
     * Get domain list
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDomainListV1'] to see the possible values for this operation
     ...
     * @return PromiseInterface
     */
    public function getDomainListV1AsyncWithHttpInfo(
        string $contentType = self::contentTypes['getDomainListV1'][0]
    ): PromiseInterface
    {
        $returnType = '\Hostinger\Model\DomainsV1DomainDomainResource[]';
     ...
     */
    public function getDomainListV1Request(
        string $contentType = self::contentTypes['getDomainListV1'][0]
    ): Request
    {
