...
class VPSFirewallApi
{
     ...
     * @throws ExceptionInterface
     */
    public function replaceAllFirewallRulesInGroupV1(int $firewallId, \Hostinger\Model\VPSV1FirewallRulesReplaceRequest $vPSV1FirewallRulesReplaceRequest)
    {
        $request = new Request(
            method: 'PUT',
            uri: $this->buildResourcePath('/api/vps/v1/firewall/{firewallId}/rules', [
            ...
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($vPSV1FirewallRulesReplaceRequest, JsonEncoder::FORMAT),
        );
     ...
     * @throws ExceptionInterface
     */
    public function syncFirewallToAllAssignedVMsV1(int $firewallId)
    {
        $request = new Request(
            method: 'POST',
            uri: $this->buildResourcePath('/api/vps/v1/firewall/{firewallId}/sync', [
                'firewallId' => $firewallId
            ]),
            headers: $this->getHeaders(),
        );
