...
class VPSFirewallApi
{
     ...
     * @throws ExceptionInterface
     */
    public function replaceAllFirewallRulesInGroupV1(int $firewallId, \Hostinger\Model\VPSV1FirewallRulesReplaceRequest $vPSV1FirewallRulesReplaceRequest, ?bool $sync = null)
    {
        $query = http_build_query(
            array_filter(
                $this->serializer->normalize([
