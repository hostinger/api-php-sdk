 ...
 */
class VPSV1MetricsMetricsCollectionRamUsage implements ModelInterface, ArrayAccess, JsonSerializable
{
    public const DISCRIMINATOR = null;

    protected static string $openAPIModelName = 'VPS_V1_Metrics_MetricsCollection_ram_usage';
