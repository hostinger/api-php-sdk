 ...
 */
class DomainsV1DomainDomainExtendedResourceNameServers implements ModelInterface, ArrayAccess, JsonSerializable
{
    public const DISCRIMINATOR = null;

    protected static string $openAPIModelName = 'Domains_V1_Domain_DomainExtendedResource_name_servers';
