 ...
 */
class CommonSchemaUnauthorizedResponseSchema implements ModelInterface, ArrayAccess, JsonSerializable
{
    public const DISCRIMINATOR = null;

    protected static string $openAPIModelName = 'Common.Schema.UnauthorizedResponseSchema';
