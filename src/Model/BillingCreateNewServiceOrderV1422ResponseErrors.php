 ...
 */
class BillingCreateNewServiceOrderV1422ResponseErrors implements ModelInterface, ArrayAccess, JsonSerializable
{
    public const DISCRIMINATOR = null;

    protected static string $openAPIModelName = 'billing_createNewServiceOrderV1_422_response_errors';
