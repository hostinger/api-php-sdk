...
class VPSV1VirtualMachineVirtualMachineResource implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'ns1' => 'string',
        'ns2' => 'string',
        'ipv4' => '\Hostinger\Model\VPSV1IPAddressIPAddressCollection',
        'ipv6' => '\Hostinger\Model\VPSV1IPAddressIPAddressCollection',
    ...
    */
     ...
     */
    public function getIpv4(): ?\Hostinger\Model\VPSV1IPAddressIPAddressCollection
    {
        return $this->container['ipv4'];
    }

    /**
     * @param \Hostinger\Model\VPSV1IPAddressIPAddressCollection|null $ipv4 ipv4
     */
    public function setIpv4(?\Hostinger\Model\VPSV1IPAddressIPAddressCollection $ipv4): static
    {
        if (is_null($ipv4)) {
     ...
     * @return \Hostinger\Model\VPSV1IPAddressIPAddressCollection|null
     */
    public function getIpv6(): ?\Hostinger\Model\VPSV1IPAddressIPAddressCollection
    {
        return $this->container['ipv6'];
    }

    /**
     * @param \Hostinger\Model\VPSV1IPAddressIPAddressCollection|null $ipv6 ipv6
     */
    public function setIpv6(?\Hostinger\Model\VPSV1IPAddressIPAddressCollection $ipv6): static
    {
        if (is_null($ipv6)) {
     ...
     */
    public function setTemplate(?\Hostinger\Model\VPSV1TemplateTemplateResource $template): static
    {
        if (is_null($template)) {
