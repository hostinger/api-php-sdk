...
**siteTitle** | **string** | WordPress site title |
...
**isValid** | **bool** | Whether the installation is considered valid |
**validationError** | **string** | Reason the installation is invalid, if any |
**createdAt** | **\DateTime** | Installation creation timestamp |
