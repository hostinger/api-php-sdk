...
| [**completeDomainSetupV1()**](DomainsPortfolioApi.md#completeDomainSetupV1) | **POST** /api/domains/v1/portfolio/{domain}/setup | Complete domain setup |
...
```php
completeDomainSetupV1($domain, $domainsV1PortfolioSetupRequest): \Hostinger\Model\CommonSuccessEmptyResource
```
...
$domainsV1PortfolioSetupRequest = new \Hostinger\Model\DomainsV1PortfolioSetupRequest(); // \Hostinger\Model\DomainsV1PortfolioSetupRequest

try {
    $result = $apiInstance->completeDomainSetupV1($domain, $domainsV1PortfolioSetupRequest);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainsPortfolioApi->completeDomainSetupV1: ', $e->getMessage(), PHP_EOL;
}
```
...
| **domainsV1PortfolioSetupRequest** | [**\Hostinger\Model\DomainsV1PortfolioSetupRequest**](../Model/DomainsV1PortfolioSetupRequest.md)|  | |
